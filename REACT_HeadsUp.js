...
// Mid Apr 2021, like 21 Apr for example

console.log( "REACT_HeadsUp invoked" );

// ============================================================================
// Make a smallish modal
// ============================================================================
class SmallishModal4 extends React.Component{
    constructor(  props  ) {
      super(  props  );
      ...
      if( this.props.WhereGo == 'top-middle' ) pickedPlace = m.placeIt4;
...
window.REACTheadsUp = function innerSmMo4( whatShows, aSpot, cb )
{
  ...
  // Apply
  ReactDOM.render(  <SmallishModal4 L1 = { daL1 } L2 = { daL2 } L3 = { daL3 } 
                     Lcb = { cb } Lcc = { daCC } WhereGo = { daAS } />,
    document.getElementById( 'reactsandbox4' ) );
}
