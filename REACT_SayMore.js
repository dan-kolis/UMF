...
console.log( "REACT_SayMore invoked" );

// ============================================================================
// Make a smallish modal
// ============================================================================
class SmallishModal2 extends React.Component{
    constructor(  props  ) {
      super(  props  );
...
window.REACTsayMore = function innerSmMo2( whatShows, aSpot, cb )
{
  ...
  // Apply
  ReactDOM.render(  <SmallishModal2 L1 = { daL1 } L2 = { daL2 } L3 = { daL3 } Lcb = { cb } Lcc = { daCC }/>, 
    document.getElementById( 'reactsandbox2' ) );
}
